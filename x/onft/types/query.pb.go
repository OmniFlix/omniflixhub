...
func (*OwnerONFTCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_a1ea6e009202d761, []int{12}
}
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a1ea6e009202d761, []int{13}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a1ea6e009202d761, []int{14}
}
...
var fileDescriptor_a1ea6e009202d761 = []byte{
	...
	,
}
