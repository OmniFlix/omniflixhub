...
// Params returns params of the flixdrop module.
...
// Params returns params of the flixdrop module.
func (k Keeper) Actions(c context.Context, _ *types.QueryActionsRequest) (*types.QueryActionsResponse, error) {
	ctx := sdk.UnwrapSDKContext(c)
	actions := k.GetActions(ctx)

	return &types.QueryActionsResponse{Actions: actions}, nil
}
