...
type Lease struct {
	...
	Leasee           string      `protobuf:"bytes,3,opt,name=leasee,proto3" json:"leasee,omitempty"`
	PricePerDay      types.Coin  `protobuf:"bytes,4,opt,name=price_per_day,json=pricePerDay,proto3" json:"price_per_day" yaml:"price_per_day"`
	...
	SettledAmount    *types.Coin `protobuf:"bytes,6,opt,name=settled_amount,json=settledAmount,proto3" json:"settled_amount,omitempty" yaml:"settled_amount"`
	StartTime        time.Time   `protobuf:"bytes,7,opt,name=start_time,json=startTime,proto3,stdtime" json:"start_time" yaml:"start_time"`
	LeasedDays       uint64      `protobuf:"varint,8,opt,name=leased_days,json=leasedDays,proto3" json:"leased_days,omitempty" yaml:"leased_days"`
	Expiry           time.Time   `protobuf:"bytes,9,opt,name=expiry,proto3,stdtime" json:"expiry"`
	Status           LeaseStatus `protobuf:"varint,10,opt,name=status,proto3,enum=OmniFlix.medianode.v1beta1.LeaseStatus" json:"status"`
	LastSettledAt    time.Time   `protobuf:"bytes,11,opt,name=last_settled_at,json=lastSettledAt,proto3,stdtime" json:"last_settled_at" yaml:"last_settled_at"`
}
...
var fileDescriptor_42ab915c4f0f53d0 = []byte{
	...
	,
}
