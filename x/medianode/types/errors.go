...
var (
	...
	ErrInvalidLeaseHours      = errorsmod.Register(ModuleName, 6, "invalid lease hours")
	...
	ErrInvalidUpdateMsg       = errorsmod.Register(ModuleName, 23, "invalid update msg")
	ErrInvalidInfo            = errorsmod.Register(ModuleName, 24, "invalid info")
	ErrInvalidDeposit         = errorsmod.Register(ModuleName, 25, "invalid deposit")
)
